  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* Mobile overlay with higher opacity */}
        <motion.div
          ...
          style={{
            background:
              'linear-gradient(to right, rgba(255, 255, 255, 0.95) 0%, rgba(240,235,224,0.85) 38%, rgba(240,235,224,0.50) 65%, rgba(240,235,224,0.20) 100%)',
          }}
        />
        {/* subtle bottom fade */}
        <motion.div
      ...
      <div className="relative z-10 flex items-center min-h-[calc(100vh-60px)] px-6 sm:px-12 lg:px-20 xl:px-28">
        ...
        >
          {/* eyebrow */}
          <motion.p 
            className="text-[#c9a84c] text-[9.5px] sm:text-[10.5px] font-bold uppercase tracking-[0.3em] mb-4 drop-shadow-none"
          ...
          {/* ornament */}
          <motion.div 
            className="flex items-center gap-[6px] mb-6"
          ...
          <motion.p 
            className="text-[#1a3a2a]/65 text-[13.5px] sm:text-[15px] leading-[1.85] max-w-[380px] mb-10"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-[9px] border border-[#1a3a2a] text-[#1a3a2a] text-[10.5px] sm:text-[11px] font-semibold uppercase tracking-[0.16em] px-6 py-[13px] hover:bg-[#1a3a2a] hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-[#1a3a2a]/25"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
