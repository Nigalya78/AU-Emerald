    ...
    <footer className="bg-forest-green">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-fraunces text-lg font-semibold text-white mb-6">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-aged-gold/50"></span>
                    {link.name}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-aged-gold flex-shrink-0 mt-0.5" strokeWidth={1.5} />
                <span className="text-white/70 text-sm">
                  466 Grand Junction Road<br />Northfield SA 5085
                </span>
              </li>
