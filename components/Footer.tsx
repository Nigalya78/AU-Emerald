        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-8 lg:gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white/45 text-[12.5px] leading-[1.75] max-w-[220px]">
              Adelaide&apos;s first South Indian jewellery store. Premium quality, timeless connection. Only at Au Emerald.
            </p>
            {/* social icons */}
          ...
          <div>
            ...
            <ul className="space-y-3 mb-5">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <span className="text-white/45 text-[11.5px]">0402 399 925 / 0430 464 562</span>
              </li>
            </ul>
            <a
              href={WA_HREF}
